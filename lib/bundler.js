...
var Bundler = function(packagePath, distributionPath, options)
{
	...
	self.bundle = new BUNDLE.Bundle(self.distributionPath + ".js");
	self.bundle.open().then(init1).fail(function(err) {
	    // We had an error opening the bundle.
	    console.log("WARNING: Error opening bundle. Resetting bundle and continuing. Error info: " + err.stack);
	...
	function init1(forceCompleteBuild)
	{
	    Q.call(function()
	    {
    	    ...
    	    function init2()
    	    {
                if (typeof self.options.bundleLoader !== "undefined") {
                    self.bundle.setBundleLoader(self.options.bundleLoader, {
